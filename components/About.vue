<template>
  <div class="py-8">
    ...
    <Card
      ...
      body="CodeReviewShop is my medium of giving back to the community. I aim to help students grow with a solid foundation of the concepts and tools we use in the industry. Since its inception, I have guided 20+ students through programming projects and lessons. I also started CodeReview Blog to share lessons about getting started with programming."
